import { BsSunFill, BsMoonStarsFill, BsFillMoonFill } from "react-icons/bs"
...
//        <>
//            {darkMode && 
//                <button onClick={handleDarkModeClick} className="flex items-center justify-center bg-rose-200 rounded text-black w-10 h-10">
//                    <BsSunFill size={25} /> 
//                </button> 
//            }
//            {!darkMode &&
//                <button onClick={handleDarkModeClick} className="flex items-center justify-center bg-cyan-800 rounded text-white w-10 h-10">
